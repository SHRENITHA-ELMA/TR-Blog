...
public class ProfileServiceImplTest {
    ...
    void testUpdateUserSuccessfully() throws IOException {
        ...
        userProfileRequest.setPassword("Password123!");
    ...
    @Test
    void testUpdateUserPasswordInvalid() {
        String emailFromToken = "test@example.com";
        UserProfileRequest userProfileRequest = new UserProfileRequest();
        userProfileRequest.setEmail("test@example.com");
        userProfileRequest.setFirstName("John");
        userProfileRequest.setLastName("Doe");
        userProfileRequest.setGender("Male");
        userProfileRequest.setPassword("123");  // Invalid password
        userProfileRequest.setCountry("USA");
        userProfileRequest.setCity("New York");
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            profileService.updateUser(emailFromToken, userProfileRequest);
    ...
    @Test
    void testUpdateUserEmailMismatch() {
        String emailFromToken = "token@example.com";
        UserProfileRequest userProfileRequest = new UserProfileRequest();
        userProfileRequest.setEmail("test@example.com");
        userProfileRequest.setFirstName("John");
    ...
    @Test
    void testUpdateWithoutPasswordAndFile() throws IOException {
        String emailFromToken = "test@example.com";
        UserProfileRequest userProfileRequest = new UserProfileRequest();
        userProfileRequest.setEmail("test@example.com");
        userProfileRequest.setFirstName("John");
        ...
        verify(userRepository).save(argThat(user ->
                user.getFirstName().equals("John") &&
                        ...
                        user.getCity().equals("New York") &&
                        user.getCountry().equals("USA") &&
                        user.getPassword().equals("oldPassword") && // Password should remain the same
                        user.getImageUrl().equals("oldImageUrl") // Image URL should remain the same
        ));
    }
    @Test
    void testUpdateUserWithoutFileProvided() throws IOException {
        String emailFromToken = "test@example.com";
        UserProfileRequest userProfileRequest = new UserProfileRequest();
        userProfileRequest.setEmail("test@example.com");
        userProfileRequest.setFirstName("John");
        ...
        verify(userRepository).save(argThat(user ->
                user.getImageUrl().equals("oldImageUrl.jpg") // Image URL should remain the same
        ));
    }
    ...
    void testUpdateUser_InvalidFileType_ThrowsInvalidFileFormatException() throws IOException {
        ...
        MultipartFile mockFile = mock(MultipartFile.class);
        when(mockFile.isEmpty()).thenReturn(false);
        when(mockFile.getContentType()).thenReturn("application/pdf"); // Invalid file type
        userProfileRequest.setFile(mockFile);
        InvalidFileFormatException exception = assertThrows(InvalidFileFormatException.class, () -> {
            profileService.updateUser(emailFromToken, userProfileRequest);
        });
        assertEquals("File must be in JPEG,JPG or PNG format", exception.getMessage());
